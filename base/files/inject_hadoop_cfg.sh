#!/bin/bash
# This script takes configuration settings
# from the environment variables and puts them into the Hadoop config.

source /entrypoints/common.sh

greenprint "Configuring Hadoop..."
